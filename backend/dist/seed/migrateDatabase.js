...
async function migrate() {
    ...
    const oldConn = await mongoose_1.default.createConnection(OLD_URI, { dbName: DB_NAME }).asPromise();
    console.log("✓ Connected to OLD Database successfully.\n");
    // 2. Connect to NEW MongoDB Connection
    console.log("📡 Connecting to NEW Database...");
    const newConn = await mongoose_1.default.createConnection(NEW_URI, { dbName: DB_NAME }).asPromise();
